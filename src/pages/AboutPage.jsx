      ...
      <div className="max-w-4xl mx-auto text-center space-y-8">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
            <h2 className="text-xl xl:text-2xl font-semibold text-gray-900 dark:text-white mb-4">
          ...
          <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
            <h2 className="text-xl xl:text-base font-semibold text-gray-900 dark:text-white mb-4">
              {t('pages.about.team.title')}
            </h2>
            <p className="text-sm xl:text-base text-gray-600 dark:text-gray-300">
